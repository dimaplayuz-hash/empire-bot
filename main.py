...
def start_command(client, message):
    ...
    if not is_user_logged_in(user_id):
        ...
        text = (
            ...
            "📱 **Qanday qilish kerak:**\n"
            "1. Telegram Desktop yoki Telegram Web ga kiring\n"
            "2. Profil -> Settings -> Advanced -> Export Data\n"
            "3. Yoki quyidagi oddiy usuldan foydalaning:\n\n"
            "🎯 **Eng oson usul:**\n"
            "• @SessionGeneratorBot ga murojaat qiling\n"
            "• U sizga session faylni beradi\n"
            "• Shu faylni shu yerga yuboring\n\n"
